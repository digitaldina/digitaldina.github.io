...
<style>
  ...
  width: 100vw;
  height: 50vh;
  background-image: url('../assets/physor_lanca_lambda.jpeg');
...
<figure alt="A picture of Dina standing in front of the main enterance to the Centro Congressi Lingotto with a poster for PHYSOR 2026">
</figure></div><br/><figcaption style="font-size: 0.8rem">Lancia Lambda (1930) display at the MAUTO Turin, Italy. A historic point in automobile engineering as the first car to feature a load-bearing unitary body, with the Lancia brand founded in 1906 in Turin.</figcaption>
<br/><br/>
...
<figure>
  <img src="../assets/physor_me_poster.jpeg" alt="A picture of me (Dina Elhanan) standing in front of my research poster presenting my group's research article NucBench: A Benchmark Framework for Evaluating Multimodal Large Language Models in Nuclear Engineering. This was during the poster session on April 22, 2026 as part of PHYSOR'26.">
  <figcaption style="font-size: 0.8rem">I presented the NucBench Benchmark as part of the Poster Sessions for PHYSOR’26, my first published paper!</figcaption>
</figure><br/>


Special shoutout to Dr. Muhammad Imron, together we were the only 2 representing the UAE at the conference, it was honor to meet the developer of KOMODO which our students at UoS at myself use often for reactor simulation (often paired with COMSOL). Incredibly impressive work given it was written before the “vibe coding” era we find ourselves in, and his current research with Khalifa University looking into approximating compression MC tally data while still retaining accuracy to reduce the memory requirement for running such codes was incredible to learn about.<br/><br/>

<figure>
  <img src="../assets/physor_muhammed_dina.jpeg" alt="A picture of me (Dina Elhanan, left) and Dr. Muhammed Imron (right) standing in front of his research poster presenting his group's research article A Tensor Train-Based Low-Rank Approximation for Monte Carlo Tallies Compression. This was during the poster session on April 22, 2026 as part of PHYSOR'26.">
  <figcaption style="font-size: 0.8rem">Dr. Muhammed Imron (right) and myself (left) in front of his research with Khalifa University presented at the PHYSOR’26 Poster Session!</figcaption>
</figure><br/>
